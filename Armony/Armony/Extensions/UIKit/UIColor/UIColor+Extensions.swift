...
// MARK: - AppColors
public extension UIColor {
    static let armonyBlack = AppTheme.Color.black.uiColor
    static let armonyBlue = AppTheme.Color.blue.uiColor
    static let armonyDarkBlue = AppTheme.Color.darkBlue.uiColor
    static let armonyDarkPurple = AppTheme.Color.darkPurple.uiColor
    static let armonyGreen = AppTheme.Color.green.uiColor
    static let armonyPink = AppTheme.Color.pink.uiColor
    static let armonyPurple = AppTheme.Color.purple.uiColor
    static let armonyRed = AppTheme.Color.red.uiColor
    static let armonyWhite = AppTheme.Color.white.uiColor
