...
final class TabBarController: UITabBarController {
    ...
    private var selectCreateAdvertClosure: VoidCallback?
    ...
    override func viewDidLoad() {
        ...
        selectCreateAdvertClosure = { [weak self] in
            self?.viewControllers?.element(at: Common.Tab.createAdvert.index)?.navigator?.popToRootViewController(animated: true)
            self?.selectedIndex = Common.Tab.createAdvert.index
        }
    }
...
extension TabBarController: UITabBarControllerDelegate {
    ...
    func tabBarController(_ tabBarController: UITabBarController,
        ...
        if !AuthenticationService.shared.isAuthenticated {
            ...
            if viewController == tabBarController.viewControllers?[Common.Tab.createAdvert.index] {
                RegistrationCoordinator().start(registrationCompletion: selectCreateAdvertClosure, loginCompletion: selectCreateAdvertClosure)
            }
            return false
        }
