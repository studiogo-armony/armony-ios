...
//  Armony
//
//  Created by Koray Yildiz on 23.03.23.
//
...
public final class LinkLabel: UILabel {
    ...
    public var hashtagColor: UIColor = .armonyBlue {
        didSet {
            createHashtagLinks()
        }
    }
...
public struct LabelLink: Equatable, Hashable {
    ...
    public init(title: String, color: UIColor, font: UIFont, shouldAddUnderline: Bool = true) {
        self.title = title
        self.color = color
        self.font = font
