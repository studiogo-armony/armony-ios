...
private extension EmptyStatePresentation {
    static var noContent: EmptyStatePresentation = {
        let title = "Müzisyen profilini kolayca oluştur ve ücretsiz ilk ilanını paylaş!".needLocalization.emptyStateTitleAttributed
        let buttonTitle = "Profil Olustur".emptyStateButtonAttributed
