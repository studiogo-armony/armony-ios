...
private struct Constant {
    static let defaultTabBarImage = "tab-account-default-icon".image
    static let selectedTabBarImage = "tab-account-selected-icon".image
}
