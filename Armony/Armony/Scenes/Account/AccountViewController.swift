...
final class AccountViewController: UIViewController, ViewController {
    ...
    private lazy var segmentedControlItems = ["Müzik Profilim".needLocalization, "İlanlarım".needLocalization, "Performanslarım"]
    ...
    private func prepareUI() {
        let homeButton = UIBarButtonItem(
            image: "account-settings-icon".image,
            style: .plain,
            target: self,
        ...
        bioLabel.collapsedAttributedLink = "daha fazla".attributed(.armonyBlue, font: .regularBody)
        bioLabel.expandedAttributedLink = "daha az".attributed(.armonyBlue, font: .regularBody)
