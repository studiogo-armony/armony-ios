...
extension AdvertsViewController: AdvertsViewDelegate {
    ...
    func configureNavigationBar() {
        navigationItem.titleView = UIImageView(image: "armony-title-icon".image)

        navigationItem.rightBarButtonItem = UIBarButtonItem(image: "home-messages-icon".image,
                                                            style: .plain,
                                                            target: self,
                                                            action: #selector(chatsButtonTapped))

        navigationItem.leftBarButtonItem = UIBarButtonItem(image: "filter-default-icon".image,
                                                           style: .plain,
                                                           target: self,
