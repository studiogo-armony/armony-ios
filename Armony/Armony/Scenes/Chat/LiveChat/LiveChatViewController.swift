...
final class LiveChatViewController: MessageKit.MessagesViewController, ViewController {
    ...
    fileprivate func configureNavigationBar() {
        ...
        navigationItem.rightBarButtonItem = UIBarButtonItem(image: "vertical-dots-three".image,
                                                            style: .plain,
                                                            target: self,
    ...
    fileprivate func configureInputBar() {
        ...
        messageInputBar.sendButton.setImage("chat_input_sendbutton_icon".image, for: .normal)
