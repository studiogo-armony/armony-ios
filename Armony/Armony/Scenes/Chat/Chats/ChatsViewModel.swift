...
private extension EmptyStatePresentation {
    ...
    static var noContent: EmptyStatePresentation = {
        let title = "Henüz mesajınız bulunmamaktadır.".emptyStateTitleAttributed
        return EmptyStatePresentation(image: "chats-empty-state-icon".image, title: title)
    }()
}
