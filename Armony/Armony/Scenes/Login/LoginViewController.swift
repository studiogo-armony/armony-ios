...
final class LoginViewController: UIViewController, ViewController {
    ...
    private var hideShowPasswordButtonImage: UIImage {
        if passwordTextField.isSecureTextEntry {
            return "registration-password-hidden-icon".image
        }
        else {
            return "registration-password-show-icon".image
        }
    }
...
//            image: "loginNavBarHomeButtonIcon".image,
//            style: .plain,
//            target: self,
//            action: #selector(homePageBarButtonTapped)
//        )
//        navigationItem.leftBarButtonItem = homeButton
//        navigationItem.leftBarButtonItem?.tintColor = .armonyWhite
//    }
//
//    @objc private func homePageBarButtonTapped() {
//        viewModel.coordinator.armony()
//    }
