...
# MARK: - REMOTE CONFING VALUES
echo "RC_SETTINGS_DATA_136 = ${RC_SETTINGS_DATA_136}" >> $CONFIG_PLIST_PATH
...
# MARK: - POPULATE REMOTE CONFIG DEFAUTL VALUES PLIST
REMOTE_CONFIG_DEFAUTL_VALUES_PLIST_PATH=""
if [ "$CI_XCODE_SCHEME" == "Armony" ]; then
    REMOTE_CONFIG_DEFAUTL_VALUES_PLIST_PATH='../Armony/Resources/Firebase/Release-Remote-Config-Defaults.plist'
else
    REMOTE_CONFIG_DEFAUTL_VALUES_PLIST_PATH='../Armony/Resources/Firebase/Debug-Remote-Config-Defaults.plist'
fi

/usr/libexec/PlistBuddy -c "Set :SettingsData_136 ${RC_SETTINGS_DATA_136}" $REMOTE_CONFIG_DEFAUTL_VALUES_PLIST_PATH
